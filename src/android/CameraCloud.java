 ...
 * @author surgar
 */
public class CameraCloud extends AppCompatActivity implements ICloudCacheManagerCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camera_cloud);
        ...
        findViewById(R.id.status_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //购买页面
                cameraCloudSDK.getCameraCloudInfo(TuyaHomeSdk.getDataInstance().getDeviceBean(devId), CameraCloud.this);
            }
        });
        ...
        findViewById(R.id.buy_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cameraCloudSDK.buyCloudStorage(CameraCloud.this,
                               TuyaHomeSdk.getDataInstance().getDeviceBean(devId),homeId,
                               //String.valueOf(FamilyManager.getInstance().getCurrentHomeId()),
                                new ICloudManagerCallback() {
                                 @Override
                                 public void onError(int i) {
                                   // Toast.makeText("hhjkk", "Get Secret Failed" , Toast.LENGTH_SHORT).show();
                                    Log.d("Cloud ","error "+i);
                                 }
                                 ...
                                 public void onSuccess(Object o) {
                                   String uri = (String) o;
                                   //Toast.makeText(this, "Get Secret Failed" , Toast.LENGTH_SHORT).show();
                                   Log.d("Cloud ","success "+uri+"  "+o);

                                   //Intent intent = new Intent(CameraCloud.this, WebViewActivity.class);
        ...
        findViewById(R.id.query_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //查询数据
                cameraCloudSDK.getCloudMediaCount(devId, TimeZone.getDefault().getID(), CameraCloud.this);
            }
        });
    ...
    public void onError(int errorCode) {
        if(errorCode==10100){
            ...
            Toast.makeText(this, "Failed to Authorize" , Toast.LENGTH_SHORT).show();
        }
        else if(errorCode==10110){
            Toast.makeText(this, "Other Exceptions" , Toast.LENGTH_SHORT).show();  
        }
        else if(errorCode==10010){
            Toast.makeText(this, "Failed to Obtain Authentication Information" , Toast.LENGTH_SHORT).show(); 
        }
        else{
            Toast.makeText(this, "Failed to get Time Slice (Authentication Information) for a Certain Day" , Toast.LENGTH_SHORT).show(); 
        }
    ...
    public void getCloudStatusSuccess(int i) {
        //返回云存储状
        if(i==10001){
            Toast.makeText(this, "Service Not Opened, Buy Cloud Storage", Toast.LENGTH_SHORT).show();
        }
        else if(i==10002){
            Toast.makeText(this, "No Data Stored" , Toast.LENGTH_SHORT).show();
        }
        else if(i==10005){
            Toast.makeText(this, "Service Expired, No Data Found", Toast.LENGTH_SHORT).show();  
        }
        else if(i==10004){
            Toast.makeText(this, "Data Found, but Service is Expired", Toast.LENGTH_SHORT).show(); 
        }
        else{
    ...
    public void startCloudRecordLocalMP4() {
        cloudCamera.startRecordLocalMp4(IPCCameraUtils.recordPath(devId), String.valueOf(System.currentTimeMillis()), new OperationDelegateCallBack() {
            @Override
            public void onSuccess(int sessionId, int requestId, String data) {
                Toast.makeText(CameraCloud.this, "record start success", Toast.LENGTH_SHORT).show();
            }
    ...
    public void stopCloudRecordLocalMP4() {
        cloudCamera.stopRecordLocalMp4(new OperationDelegateCallBack() {
            @Override
            public void onSuccess(int sessionId, int requestId, String data) {
                Toast.makeText(CameraCloud.this, "record end success", Toast.LENGTH_SHORT).show();
            }
    ...
    public void snapshot() {
        cloudCamera.snapshot(IPCCameraUtils.recordSnapshotPath(devId), new OperationDelegateCallBack() {
            @Override
            public void onSuccess(int sessionId, int requestId, String data) {
                Toast.makeText(CameraCloud.this, "snapshot success", Toast.LENGTH_SHORT).show();
            }
