...
public class PlaybackTime  extends RecyclerView.Adapter<PlaybackTime.MyViewHolder>  {
   private LayoutInflater mInflater;
     private List<TimePieceBean> timePieceBeans;
     private OnTimeItemListener listener;

    public PlaybackTime(Context context, List<TimePieceBean> timePieceBeans) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(mInflater.inflate(R.layout.activity_camera_playback_time, parent, false));
    }
